 ...
 * @author amir
 */
public class FotballFieldCoverController implements Initializable {
    ...
    public void Add_users (){
        ...
        String sql = "insert into orar_terenacoperit (Orar)values(? )";
        try {
    ...
    void search_user() {
        ...
        dataList = DatabaseConnection.getDatausers4();
