 ...
 * @author amir
 */
public class HandballFieldController implements Initializable {
    ...
    public void Add_users (){
        ...
        String sql = "insert into orar_terenhandball1 (Orar)values(? )";
        try {
    ...
    public void Edit (){
        try {
            ...
            /*??????*/String sql = "update orar_terenhandball1 set Orar= '"+value1+"' where Orar='"+value1+"' ";
            pst= connectDB.prepareStatement(sql);
            pst.execute();
    ...
    public void Delete(){
        DatabaseConnection connectNow = new DatabaseConnection();
        Connection connectDB = connectNow.getConnection();
        String sql = "delete from orar_terenhandball1 where Orar = ?";
        try {
            pst = connectDB.prepareStatement(sql);
            pst.setString(1, txt_hours.getText());
            pst.execute();
    ...
    void search_user() {
        ...
        dataList = DatabaseConnection.getDatausers7();
